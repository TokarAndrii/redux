...
Finally, import the newly created `.scss` file instead of the default Bootstrap `.css` in the beginning of your `src/home.js` file, for example:
...
following in their [`src/home.js`](src/home.js) file:
...
- If the watcher doesn’t see a file called `home.js` and you’re referencing it by the folder name, you [need to restart the watcher](https://github.com/facebook/create-react-app/issues/1164) due to a Webpack bug.
